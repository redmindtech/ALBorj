            ...
            <div class="card shadow">
                                ...
                                <tbody>
                                    @foreach ($employes as $key => $employe)
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a  onclick="handleShowAndEdit('{{$employe->id}}','show')" class="btn btn-primary btn-circle btn-sm"   >
                                                    <i class="fas fa-flag"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a onclick="handleShowAndEdit('{{$employe->id}}','edit')" class="btn btn-info btn-circle btn-sm mx-2" >
                ...
                <dialog id="myDialog"  style="width:1000px;">
                    ...
                    <form  class="form-row"  enctype="multipart/form-data" style="display:block" id="form" onsubmit="handleSubmit()">
                        ...
                        <div class="row">
                            <label>Over Time:<input type="checkbox" id="over_time" name="over_time" value="1" {{ old('over_time') ? 'checked' : '' }}></label>
                        </div>
                        <div class="form-group col-md-12">
