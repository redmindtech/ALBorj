    ...
    <dialog id="myDialog">
        ...
        <form  class="form-row"  enctype="multipart/form-data" style="display:block" id="form" onsubmit="handleSubmit()">
            ...
            <div class="row g-3">
                ...
                <div class="form-group col-md-4">
                    <label for="exp_category_no" class="form-label fw-bold">Expense Category<a style="text-decoration: none;color:red">*</a></label>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="number" id="bill_amount"  name="bill_amount" value="{{ old('bill_amount') }}" placeholder="Bill Amount" class="form-control" autocomplete="off">
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4" id='chequeNo' style="display: none;">
                    <label for="cheque_no" id="cheque_lable" class="form-label fw-bold">Cheque No</a></label>
                ...
                <div class="form-group col-md-4" id='chequeDate' style="display: none;">
                    <label for="cheque_date"  id="date_lable" class="form-label fw-bold">Cheque Date</a></label>
                    ...
                    $(document).on('focusout', '.select2-selection', function()
                    {
                        ...
                        if ($(this).attr('aria-labelledby') == 'exp_category_no-label')
                        {
                            if (!/^[A-Za-z0-9\s\W]+$/i.test(value)) {
                                $("#exp_category_no-error").text("Please enter the valid expenses category.");
