        ...
        <div class="container-fluid">
            ...
            <script type="text/javascript">
                function handleDialog() {
                    ...
                    $('#method').val("ADD");
                    $('#submit').text("ADD");
                    $('#heading_name').text("Add Item Master").css('font-weight', 'bold');
                    $('#supplier_id').hide();
                ...
                function handleShowAndEdit(id, action) {
                    ...
                    $.ajax({
                        ...
                        success: function(message) {
                            ...
                            if (action == 'edit') {
                                console.log('edit')
                                $('#heading_name').text("Update Item Master").css('font-weight', 'bold');
                                $('#show').css('display', 'none');
                                $('#form').css('display', 'block');
                                $('#blur-background').css('display', 'block');
                                ...
                                $('#heading_name').text("View Item Master").css('font-weight', 'bold');
