                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="form-group col-md-6" hidden>
                            ...
                            <input type="text" name="supplier_no" hidden value="{{old("supplier_no",$supplier->supplier_no)}}"placeholder="Supplier No" class="form-control u_no " id="u_no" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="code" value="{{old("code",$supplier->code)}}" placeholder="SupplierCode" class="form-control  code" disabled id="u_code" required>
...
//    alert ($(this).attr("id"));
   $.ajax({
    ...
    success: function(data) {
       ...
       $('.supplierno').val(data[0].supplier_no);
