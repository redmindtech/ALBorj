                    ...
                    <div class="card shadow">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h4 class="font-weight-bold text-dark py">TimeSheet</h4>
...
// create table
    for(let i = 0; i <= diffDays; i++) {
        ...
        $('#tbody').append(`<tr id="R${i}">
            <td class="row-index">
                <p><input type="date" class="date" name="date[]" value="${formattedDate}" id="date_${i}" ></p>
            </td>
            <td class="row-index">
            ...
            <td class="row-index">
                <p><input type='text' class="total_time" name='total_time[]' id="total_time_${i}"></p>
            </td>
            <td class="row-index">
            ...
            <td class="row-index">
                <p><input type='text'class="ot_total_time"  name='ot_total_time[]' id="ot_total_time_${i}"></p>
            </td>
            <td class="row-index">
                <p><input type='checkbox' class="holiday"  name='holiday[]' id='holiday_${i}' value=1 "{{ old('holiday') ? 'checked' : '' }}"></p>
            </td>
            <td class="row-index">
                <p><input type='checkbox' class="leave"   name='leave[]' id='leave_${i}' value=1 "{{ old('leave') ? 'checked' : '' }}" ></p>
            </td>
            <td class="row-index">
                <p><input type='text' class="leave_type" id="leave_type_${i}" name='leave_type[]'></p>
            </td>
        </tr>`);
    } 
}
        ...
        ({
            ...
            success: function (message)
            {
                if(action == 'edit')
                {
                    ...
                    dateCal();
                    $('#date').val(item.date);
                    $('#start_time_'+i).val(item.start_time);
                    $('#end_time_'+i).val(item.end_time);
                    $('#total_time_'+i).val(item.total_time);
                    $('#ot_start_time_'+i).val(item.ot_start_time);
                    $('#ot_end_time_'+i).val(item.ot_end_time);
                    $('#ot_total_time_'+i).val(item.ot_total_time);
                    $('#holiday_'+i).val(item.holiday);
                    $('#leave_'+i).val(item.leave);
                    $('#leave_type_'+i).val(item.leave_type);
                    i++;
                    }
